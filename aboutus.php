...
<html>
    ...
    <head>   
        ...
        .sliding1:hover:before {
            left: 0;
            opacity: 1;
            color: rgb(13, 57, 138);
        }

        .sliding1:hover:after {
            left: 10%;
            opacity: 0;
    ...
    <body>
        ...
        <div class="container-fluid my-auto" style="background-color:#fff;">
            <div class="row ">     
                <div class="col-md-4 align-items-center mx-auto my-auto">
                    ...
                    <p style="font-size:1.3em;">No matter where you are in your journey, here's where you need to be.</p>
                </div>
                <div class="col-md-6">
                    <img src="images/img1-diabetics.jpg" alt="Your Image" class="rounded" style="width:100%;height:100%;">
                </div>
            </div>
        </div>
        <div class="container mt-5 mb-5">
            <div class="col-md-6-fluid">
                <h2 class="text-success">Help is Here</h2>
        ...
        <div class="container-fluid my-auto" style="background-color:#ccc;">
            <div class="row ">
            <div class="col-sm-6">
                    <img src="images/symnp.png" alt="Your Image" class="rounded" style="width:100%;height:auto;">
                </div>
                <div class="col-md-4 my-auto mx-auto">
                    <h4 style="color:#287546;">ABOUT DIABETES</h4>
                    <h1>Understanding Diabetes</h1>
                    <p style="font-size:1.2em;">From symptoms and treatment, to management and medication—arm yourself with the knowledge to live well with diabetes.</p>
                    <div class="u_list">
                    ...
                    <button class="sliding1" onclick="NextPage()" style="color:#fff;">&nbsp;</button><br><br><br>
                </div>
        ...
        <div class="container-fluid my-auto" style="background-color:#ccc;">
            <div class="row ">
                ...
                <div class="col-md-4 align-items-center mx-auto my-auto">
                    <h4 style="color:#287546;">About Diabetes</h4>
                    <h1>Warning Signs</h1>
                    <p style="font-size:1.2em;">Learn to recognize the warning signs of diabetes and how to find out if you have it.Know the warning signs and symptoms of diabetes and diabetes complications so you can take action to improve your health</p>
                    <button class="sliding" onclick="NextPage()" style="color:#fff;">&nbsp;</button><br><br><br>
                </div>
                <div class="col-sm-6 ml-auto">
                    <img src="images/img2_1.png" alt="Your Image" class="rounded" style="width:100%;height:auto;">
                </div>
            </div>
        </div>
